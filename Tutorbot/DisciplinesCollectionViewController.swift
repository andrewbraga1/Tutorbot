//
//  DisciplinesCollectionViewController.swift
//  Tutorbot
//
...
class DisciplinesCollectionViewController: UICollectionViewController {
    var disciplines: [Discipline] = [Discipline]()
    let cellIdentifier = "DisciplineCell"
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellIdentifier, for: indexPath) as? DisciplinesCollectionViewCell else{
            fatalError("erro no cast")
        }
