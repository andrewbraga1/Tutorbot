...
class DisciplinesTableViewController: UITableViewController {
    ...
    let cellIdentifier = "DisciplinesIdentifier"
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: cellIdentifier, for: indexPath) as? DisciplinesTableViewCell else{
            fatalError("Erro Table cell")
        }
